...
export default function LogIn() {
  ...
  return (
    <div>
      ...
      <p style={{marginBottom: `0px`}}>התהליך אורך 30-40 דקות ויש לעבור אותו בסביבה המאפשרת נוחות ושקט ללא הפרעות והסחות דעת מתחילתו ועד סופו. רציפות התהליך הינה תנאי הכרחי להצלחה.
