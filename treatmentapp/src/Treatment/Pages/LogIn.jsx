...
export default function LogIn() {
  ...
  return (
    <div>
      ...
      <p style={{margin: `0px`, backgroundColor: 'red'}}>לתשומת ליבך- כדי לנקוט משנה זהירות נוכל להיכנס לתהליך עבור אלרגיות שקיבלו את אישורך המפורש שהן אינן מוגדרות כמסכנות חיים עבורך.</p><br />
