...
export default function AllergyInfo() {
  ...
  return (
    <div>
      <input type="number" placeholder='האם אתה מוכן להשקיע (זמן/כסף) כדי להיפתר מהאלרגיה ממנה אתה סובל, או להפחית אותה משמעותית, ללא צורך בנטילת תרופות? בסולם של 1-10, כאשר 1 מסמל כלל לא, ו 10 מסמל המון)' />
      <input type="number" placeholder='כמה היית מוכן לשלם על טיפול מהסוג הזה מתוך הנחה/אמונה/תקווה שהוא יהיה יעיל לתקופה ארוכה? אפשרויות לבחירה אחת: 0, 25, 40, 55, 75, 100, 150  (ש"ח). ' />
      <input type="text" placeholder='האם אתה מחוייב לעצמך להשתתף באופן פעיל בתהליך ההנחיה שבמערכת שלנו כדי להגביר את הסיכוי להפחתת הרגישות האלרגית שלך? ' />
      {flag ? (
